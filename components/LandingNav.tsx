...
export default function LandingNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-gradient-to-r from-[#0b1f4d] to-[#123a78] shadow-lg">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-white text-sm">
          ...
          <a href="#" className="hover:text-blue-100 transition">Modules</a>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-[#0b1f4d] px-4 py-4 space-y-3">
          <a href="#" className="block text-white hover:text-blue-100 transition py-2">Home</a>
          <a href="#" className="block text-white hover:text-blue-100 transition py-2">Features</a>
          <a href="#" className="block text-white hover:text-blue-100 transition py-2">Modules</a>
          <a href="#" className="block text-white hover:text-blue-100 transition py-2">About</a>
