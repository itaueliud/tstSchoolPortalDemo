    ...
    <Layout role="parent">
      <div className="md:col-span-3 card p-6">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
          ...
          <Link href="/parent/dashboard" className="text-sm font-semibold text-green-700 hover:text-green-800">
            Back to dashboard
          </Link>
        </div>
              ...
              <div key={statement.id} className="rounded-lg border border-gray-100 p-4 bg-gray-50">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">{statement.student_name} • {statement.class} • Due {statement.due_date ? new Date(statement.due_date).toLocaleDateString() : 'N/A'}</p>
